...
1. Everyone opens their player URL. You have **$2,500**. That is your entire budget for the whole game, not just the draft.
...
| 7 | Your remaining budget cannot cover any remaining property? You get the **cheapest remaining property at no cost.** |

Rule 7 hands you a free deed rather than cash because **everyone ending with exactly seven deeds is load-bearing.** The $8-per-deed carrying cost is only fair because deed counts are equal — a player holding six would pay a permanently lower levy for the rest of the game. Running out of money in the draft never costs you a deed. It costs you the *choice* of deed.
...
**The lesson that costs people the most money:** you pay your own bid. Ana would have won Reading Railroad for $291. She wrote $340 because she was thinking about her ceiling instead of her price — and $340 is 22% of the roughly $1,575 she can afford to spend across all seven rounds. Write down what the deed is worth to you, not what you can afford.

### What a good first-round submission looks like

**Know what you are buying a railroad for.** The four railroads are the highest-traffic *set* on the board at 9.97% combined, and they are the only set you can complete without a single trade — four deeds acquired individually, no colour group to finish, no even-build development, no negotiation with a player who knows you need them. In a game where monopolies are rare by design, that is worth a real premium.

**It is not worth that premium because railroads are busy.** They are not. At **2.49% per square** they sit *below* the board average of 2.51% — below orange, yellow, red and green. Reading Railroad at 2.27% is the fifth-quietest purchasable square on the board. Buy the set. Do not tell yourself you are buying traffic.

**Traffic barely varies, so stop drafting for it.** The busiest property on this board (Tennessee Avenue, 2.77%) is landed on only **1.27 times** as often as the quietest (Park Place, 2.19%). Standard Monopoly's ratio is 1.50. With the spread this flat, a deed's value comes almost entirely from **its rent table and how far you can develop it** — and development is something you choose, not something the dice hand you. Draft for rent ceilings and for group completability. Draft for position only at the margin.
...
The only phase in which you take financial actions, and everyone takes them simultaneously in their own view.

**If anyone was marked for liquidation at the last Settlement, that resolves first**, before anything else, as a facilitator-run auction among the other three players. Then, depending on the era, this is where you:

- draw on or repay your bank credit line, and **repay distressed debt**
...
The app runs eleven steps in exactly this order. The order is worth knowing because it decides things — an audit fine lands at step 9 and margin calls are flagged at step 10, so a fine can and will trigger a call in the same Settlement.
...
**On round 24 only**, three further steps follow: all pools terminate, every tranche short of its face triggers its referencing CDS, then scoring runs.
...
**What's new:** everything. Rent, building, mortgages, trading, one credit line — and a carrying cost that starts draining you from the very first Settlement.
...
Deeds and cash, in any combination, with any player, in any Open phase. Enter the deal in the app; both sides confirm. Encumbered deeds carry their encumbrances to the new owner (relevant from Era II — see section 5).
...
| Go To Jail (30) | Straight to Jail, no $350. The only square on the board that moves you. |
| Jail (10) | Pay $50 on your next turn and leave. Mandatory. |
| Chance (7, 22, 36) and Community Chest (2, 17, 33) | Ordinary squares. You stop there, the facilitator taps draw, and the app deals from the **Era I deck**. The physical cards are not used and no card moves your token. |
...
Interest is due each Settlement, at step 5. The lender holds a **note**, which is an asset — sellable outright, and poolable into a CDO once Era III opens.

A peer loan does not touch your borrowing base, which makes it the cleanest way to cure a margin call: you raise cash without giving up any base at all.
...
**Every Settlement from round 13 onward, at step 9, the app rolls 2d6 against your Heat. If the roll is less than or equal to your Heat, you are audited.**
...
**Equity gets a rating too.** It has no face amount, so its claim is defined as `expected pool cashflow − senior face − mezzanine face`. The cumulative claim through equity is therefore the whole pool, its coverage evaluates to exactly **1.00**, and equity rates **CCC** in any pool with meaningful concentration or leverage. That is correct. The residual tranche is genuinely the riskiest thing in the structure.
...
1. **All CDO pools terminate**, whether or not their underlying assets have run their course.
2. **Every tranche short of its face triggers its referencing CDS.** If you wrote protection, this is when you pay.
3. **Scoring runs.**
...
| II — Expansion | 7–12 | **6%** | Peer loans, rent futures, ventures, laundering, bribery. $300 stimulus at the start of round 7, **as a loan**. |
...
| Leaving Jail | $50 |
| Era II stimulus, round 7 | $300 per player, added to drawn credit |
...
The single most important dataset in the game. Use it to price rent futures.

| Group | Squares | Combined | Per square |
|---|---|---|---|
| **Railroads** | 5, 15, 25, 35 | **9.9684%** | 2.4921% |
| **Orange** | 16, 18, 19 | 8.2293% | **2.7431%** |
| Yellow | 26, 27, 29 | 8.1013% | 2.7004% |
| Red | 21, 23, 24 | 8.0150% | 2.6717% |
| Green | 31, 32, 34 | 7.7401% | 2.5800% |
| Pink | 11, 13, 14 | 7.2522% | 2.4174% |
| Light Blue | 6, 8, 9 | 6.8199% | 2.2733% |
| Utilities | 12, 28 | 5.0602% | 2.5301% |
| Brown | 1, 3 | 4.6250% | 2.3125% |
| Dark Blue | 37, 39 | 4.4440% | 2.2220% |

All 28 purchasable squares combined: **70.2556%**. Average per purchasable square: **2.5091%**.

**Four facts worth internalising:**

**Orange is the best colour group, and Jail is the entire reason.** At 2.74% per square it leads all ten groups. Jail is the most-landed square on the board at 5.33%, and orange sits six to nine squares past it, right in the middle of the 2d6 distribution.

**The railroads lead by count, not by quality.** Their 9.97% combined is the highest of any set, but at **2.49% per square they sit below the 2.51% board average** — below orange, yellow, red and green. They are worth drafting because four deeds acquired individually form a complete set with no trade, no colour-group completion and no even-build development required. They are not worth drafting because any individual railroad is busy. It is not.

**Dark blue is the worst-trafficked group on the board** at 2.22% per square. Boardwalk draws 2.2553% — less often than Mediterranean Avenue. Its rent is the largest in the game and its frequency is nearly the smallest, so correctly priced rent futures on it sit far below where instinct puts them.

**Traffic is deliberately flat.** The busiest purchasable square (Tennessee, 2.77%) beats the quietest (Park Place, 2.19%) by a ratio of only **1.27×**. Standard Monopoly's is 1.50×. With the spread this compressed, deed value is dominated by **rent tables and development potential**, not by board position — which makes the rent futures market a read on what your opponents intend to build.
...
The six card squares take **14.89% of all rolls between them**, so expect a draw roughly every seventh roll at the table. They are not equally likely: square 17 sits exactly seven past Jail, on the crest of the wave of players leaving it, and is the busiest non-Jail square on the board at 2.82% — about 24% more often than square 7.
...
An audit seizes **all** your dirty cash, charges the fine **in clean cash**, and resets your Heat to 0. Read the haircut column at your Heat *before* the laundering transaction's own +1.
...
Equity's claim = expected pool cashflow - senior face - mezzanine face,
so equity's coverage is always exactly 1.00.
```
...
Read across the bottom row: the worst possible pool in the game still only knocks half off the coverage ratio. Coverage is what the rating measures. Everything else is a rounding error, which is the point. Note also that this multiplier *is* equity's score, since equity's coverage is always 1.00.
...
```
Landing probability, Boardwalk          2.2553% per roll
Rolls that can owe you rent             3 x 1.19 x 8 rounds  =  28.56
Expected hits                           28.56 x 0.022553     =   0.64
Expected value                          0.64 x $2,000        =  $1,288
```

Now the part that matters:

```
Chance of ZERO hits over the window     (1 - 0.022553)^28.56  =  52%
...
**Half the time this contract pays absolutely nothing.** Its $1,288 expected value is the average of a coin flip between $0 and $2,000, with a modest tail.
...
You cut it: **Senior $700, Mezzanine $600, Equity the residual.** Senior + Mezzanine = $1,300, comfortably under the $2,080 cap. Equity's claim is $2,080 − $700 − $600 = **$780**.
...
EQUITY      coverage = 2,080 / 2,080 = 1.000    (always, by definition)
            score    = 1.000 x 0.5435 = 0.543   ->  CCC
```

**Your senior slice is rated AA and every dollar behind it depends on one over-levered player.** The rating is correct arithmetic. It is also useless, and the app says so on the same line: right next to "AA" it prints *concentration 1.00, weighted leverage 3.8*. Sell to whoever reads the letter and not the line beneath it.
...
| Equity | 1.000 | 0.543 → **CCC** | 0.804 → **BB** |

One rating notch on the senior, two on the mezzanine, two on the equity. Diversification is worth less here than it should be. That is deliberate.
...
You are Riley. You own St. James, Tennessee and New York Avenue (the full orange group, **all hoteled**) and **all four railroads**. Seven deeds — the strongest rent position available on this board. It is round 9.
...
```
Expected landings   0.1820 x 3.57 x 4 rounds     =   2.60
Payout              2.60 x $150                  =   $390 dirty
